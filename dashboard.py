...
""", unsafe_allow_html=True)
st.sidebar.radio("", ["🔴 Overview", "📊 Data Understanding", "⚙️ Preprocessing", "🤖 Model Evaluation", "✅ Kesimpulan"], label_visibility="collapsed")
st.sidebar.markdown("""
...
<b>Dataset</b><br>918 pasien, 12 atribut<br><br><b>Metode</b><br>K-Means, Logistic Regression, Gaussian Naive Bayes<br><br><b>Model terbaik</b><br>Gaussian Naive Bayes
</div>
""", unsafe_allow_html=True)
...
<div class="hero">
  ...
  <p><b>Sistem visualisasi hasil penelitian penyakit jantung.</b> Dashboard ini merangkum isi laporan mulai dari latar belakang, deskripsi dataset, penjelasan atribut, preprocessing, evaluasi model, sampai kesimpulan akhir.</p>
  <div class="badge-row"><span class="badge">918 Data Pasien</span><span class="badge">11 Fitur + 1 Target</span><span class="badge">Balanced Dataset</span><span class="badge">ROC AUC NB 0.9225</span></div>
</div>
""", unsafe_allow_html=True)

st.write("")
col1, col2, col3 = st.columns(3)
for col, icon, title, value, desc in [
    (col1, "👥", "Total Data", "918", "Jumlah seluruh data pasien"),
    (col2, "🫀", "Sakit Jantung", "508", "55,3% dari total data"),
    (col3, "✅", "Tidak Sakit", "410", "44,7% dari total data"),
]:
    with col:
...
with c1:
    ...
    st.markdown("""
    <div class="text-card">
    1. Bagaimana karakteristik data klinis pasien?<br>
    2. Atribut apa yang berhubungan kuat dengan penyakit jantung?<br>
    3. Bagaimana membangun model Logistic Regression?<br>
    4. Bagaimana performa Naive Bayes dibanding model lain?
    </div>
    """, unsafe_allow_html=True)
with c2:
    ...
    st.markdown("""
    <div class="text-card">
    Mengidentifikasi pola data, mengelompokkan risiko pasien, membangun model klasifikasi Logistic Regression dan Gaussian Naive Bayes, lalu membandingkan performa keduanya berdasarkan metrik evaluasi.
    </div>
    """, unsafe_allow_html=True)

st.divider()
st.markdown('<div class="section-title">Data Understanding</div>', unsafe_allow_html=True)
st.markdown("""
<div class="text-card">
...
st.markdown("""
<div class="text-card">
Hasil EDA menunjukkan pasien berusia di atas 50 tahun cenderung memiliki risiko lebih tinggi. Tipe nyeri dada ASY atau asymptomatic memiliki proporsi sakit jantung tertinggi, yaitu 79,0%, sehingga penyakit jantung dapat muncul tanpa gejala nyeri dada yang khas. Atribut Oldpeak, MaxHR, ST_Slope, ChestPainType, dan ExerciseAngina menjadi fitur yang paling informatif terhadap status penyakit jantung.
</div>
""", unsafe_allow_html=True)
...
with right:
    ...
    st.markdown("""
    <div class="insight-box"><b>Gaussian Naive Bayes menjadi model terbaik.</b><br><br>Model ini unggul pada Accuracy, Precision, Recall, F1-Score, dan ROC AUC. Recall tinggi penting karena model lebih mampu mendeteksi pasien yang benar-benar sakit sehingga risiko kasus tidak terdeteksi dapat dikurangi.</div>
    """, unsafe_allow_html=True)
    st.write("")
    st.markdown("""
    <div class="matrix-box"><b>Confusion Matrix Naive Bayes</b><br><br>True Negative: 70<br>False Positive: 12<br>False Negative: 11<br>True Positive: 91</div>
    """, unsafe_allow_html=True)
